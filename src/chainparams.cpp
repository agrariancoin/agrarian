...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("agr1.pacificao.com", "agr1.pacificao.com"));
        vSeeds.push_back(CDNSSeedData("agr2.pacificao.com", "agr2.pacificao.com"));
        vSeeds.push_back(CDNSSeedData("MN1.agrariancoin.com", "MN1.agrariancoin.com"));
        vSeeds.push_back(CDNSSeedData("MN2.agrariancoin.com", "MN2.agrariancoin.com"));        
